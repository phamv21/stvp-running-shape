...
export default function SeachRouteElement(props){
    ...
    return(
        <div className='btn btn-light d-flex justify-content-between' value={props.route.id} onMouseEnter={e => {props.handleHighlight(props.route.id) }} onMouseLeave={e => {props.handleHighlight(null) } } onClick={e => props.handleRouteRender(props.route.id)}>
